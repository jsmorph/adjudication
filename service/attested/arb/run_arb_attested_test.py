...
SCRIPT = Path(__file__).with_name("run-arb-attested.py")
SPEC = importlib.util.spec_from_file_location("run_arb_attested", SCRIPT)
...
class CasePacketTest(unittest.TestCase):
    def test_stage_uses_installed_aar(self):
