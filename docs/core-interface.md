...
The tested pair `service@de0e4b633ace8dc3b19ec1f4bb74b1f1c535b2b1` and `carve@e887cc3e0379b5a3eb9892a4183b6e6259d75305` passes the complete compatibility suite.  The selected core revision builds ADC, ARB, and AARD with Lean 4.32.0, while the service revision contains no copied procedure source.  This pair tests the command, private HTTP, and artifact boundary after the branch split and auxiliary service pruning.
