...
import (
	...
	"adjudication/arbd/runtime/service"
)
...
func runService(ctx context.Context, args []string, stdout io.Writer, stderr io.Writer) error {
	...
	aardBin := fs.String("aard-bin", "", "Path to aard binary used for child cases")
	...
	attestedImageTarS3 := fs.String("attested-image-tar-s3", "", "Default S3 tarball for the arbd image")
